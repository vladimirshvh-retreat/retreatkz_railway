                ...
                <FadeIn direction="up" delay={0.2}>
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button size="lg" className="px-10 py-6 text-lg bg-retreat-brown hover:bg-retreat-brown-dark text-white border-none shadow-sm rounded-full transition-all hover:scale-105">
                                Забронировать место
                            </Button>
                        </DialogTrigger>
